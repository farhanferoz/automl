...
class PyTorchModelBase(BaseModel, ABC):
        ...
        for epoch in range(int(self.n_epochs)):
            ...
            if self.early_stopping_rounds is not None and X_val is not None:
                ...
                with torch.no_grad():
                    ...
                    val_final_predictions, _, _, _ = self.model(X_val_tensor)
    ...
    def get_hyperparameter_search_space(self) -> dict[str, Any]:
        ...
        space = {
            ...
            # "n_epochs": {"type": "int", "low": 10, "high": 100, "step": 10},
        ...
        if self.is_regression_model:
            # space["uncertainty_method"] = {"type": "categorical", "choices": [e.value for e in UncertaintyMethod] if self.is_regression_model else [UncertaintyMethod.CONSTANT.value]}
            # Add MC Dropout specific parameters if the uncertainty method is an option
