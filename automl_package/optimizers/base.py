...
class OptimizerWrapper(ABC):
    ...
    def _calculate_total_loss(
        self, model: torch.nn.Module, loss_fn: callable, regularization_fn: callable, batch_x: torch.Tensor, batch_y: torch.Tensor, forward_pass_kwargs: dict | None = None
    ...
    @abstractmethod
    def step(self, model: torch.nn.Module, loss_fn: callable, regularization_fn: callable, optimizer: torch.optim.Optimizer, batch_x: torch.Tensor, batch_y: torch.Tensor, forward_pass_kwargs: dict | None = None) -> None:
